...
class UserRepositoryTest {
	...
	private void createRecrods()
	{
		// Prepare User Entity
	     ...
	     userEntity2.setFirstName("Davain Pablo");
	     userEntity2.setLastName("Edwards");
	     ...
	     addressEntity2.setCity("Toronto");
